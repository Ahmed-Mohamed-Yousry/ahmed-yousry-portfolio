...
const Services = () => {
  return (
    ...
    >
      ...
      <h2 className='text-4xl font-bold font-Ovo dark:text-white'>My Services</h2>

      <p className='text-center max-w-6xl text-gray-500 font-Ovo mt-4 mb-12 dark:text-gray-300'>
    ...
    dark:hover:border-white'
          >
            ...
            <a 
              ...
              className='text-sm underline mt-4 flex gap-2 items-center justify-start dark:text-black'
            >
