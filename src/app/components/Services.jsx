...
const Services = () => {
  return (
    <div className='w-full flex flex-col justify-center items-center text-center gap-6 mt-20 mb-10 px-4 scroll-mt-24' id="services">
      <p className='font-Ovo text-lg text-gray-500'>What I offer</p>
      <h2 className='text-4xl font-bold font-Ovo'>My Services </h2>

      <p className='text-center max-w-6xl text-gray-500 font-Ovo mt-4 mb-12 '>
...
<div className='grid grid-cols-auto gap-6 w-full my-6'>
  {serviceData.map(({icon, title, description, link}, index) => (
    <div key={index} className='flex flex-col rounded bg-[#ada1f9] shadow-sm p-4 text-white 
      ...
      <h3 className='text-lg font-Outfit mb-2 text-gray-700 '>{title}</h3>
